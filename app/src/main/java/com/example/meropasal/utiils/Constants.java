...
/*This class holds important constant values
...
public class Constants {
    ...
    public static final  String BASE_URL = "http://192.168.100.14:3200/api/";

    //Tokens received from the API
    public static final  String TOKEN = "token";
    public static final String USER_ID = "user";
    public static final String  ACCOUNT = "account";
    public static final String IMAGE_URL = "http://192.168.100.14:3200/public/images/";
